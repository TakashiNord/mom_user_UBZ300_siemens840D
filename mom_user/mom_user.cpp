...
e-mail: jura@csoft.ru, g00@inbox.ru\nHTTP: http://www.csoft.ru\n\n(c) 2007.\n\n\nПоследняя редакция июль 2007\0";
    ...
    if ( !strcmp(argv[1], "INPUT_ZERO") )
    {
      char ca2[133] ;
      int  ir3 ;
      UF_UI_close_listing_window();
      UF_UI_lock_ug_access(UF_UI_FROM_CUSTOM);
      uc1600(":Введите номер нуля программы:", ca2, &ir3);
...
int sub_10001720()
{
  ...
  int i ;
  static DWORD sp[]=
  {  0x60B4D4DA , 0x0BCEC3EDA , 0x1C6992FB , 0x9C21B9ED , 0x0C4DF5004 , 0x84AA257A , 0x0A4FAE1E1 , 0x448110E6 ,
     0x6CC1F948 , 0x949773FF , 0x2CFCB78A , 0x74B01096 , 0x0B4D64A62 , 0x0B8DEBF73 , 0x0C0734171 , 0x1562297F ,
     0x4C066F68 , 0x1420AED1 , 0x6C215133 ,
     1 } ;
